...
// Seed initial sample tickets if database is empty to demonstrate the system immediately
  ...
  seed.tickets = [
    {
      id: 'CLOE-1001',
      uuid: 'tk-seed-001',
      title: 'Fallo al aplicar descuento en Checkout Cloe Factory Store',
      store: 'cloefactorystore.com.mx',
      category: 'vtex_checkout',
      priority: 'p1_critical',
      status: 'in_progress',
      requesterEmail: 'mariana.lopez@oemoda.com',
      requesterName: 'Mariana López',
      department: 'Marketing & Promociones',
      affectedUrl: 'https://cloefactorystore.com.mx/checkout',
      orderId: 'vtex-cfs-984210',
      description: 'Los clientes reportan que el cupón FACTORY30 no calcula el 30% adicional en bolsas seleccionadas al llegar al paso de pago.',
      attachments: [],
      slaHours: 4,
    ...
    },
    {
      id: 'CLOE-1002',
      uuid: 'tk-seed-002',
      title: 'Sincronización de inventario con ERP para nueva colección Bolsos',
      store: 'cloe.com.mx',
      category: 'integrations_erp_crm',
      priority: 'p2_high',
      status: 'triaged',
      requesterEmail: 'carlos.mendoza@oemoda.com.mx',
      requesterName: 'Carlos Mendoza',
      department: 'Operaciones & Logística',
      affectedUrl: 'https://cloe.com.mx/coleccion-primavera',
      orderId: '',
      description: 'Se cargaron 15 SKUs en el ERP pero no reflejan stock en el catálogo VTEX de cloe.com.mx. Necesitamos que se sincronice el webhook de inventario.',
      attachments: [],
      slaHours: 24,
    ...
    },
    {
      id: 'CLOE-1003',
      uuid: 'tk-seed-003',
      title: 'Reporte mensual de ventas por categoría y tasa de conversión VTEX',
      store: 'both',
      category: 'reports_dba',
      priority: 'p3_medium',
      status: 'resolved',
      requesterEmail: 'direccion.comercial@oemoda.com',
      requesterName: 'Lic. Sofia Ramos',
      department: 'Dirección Comercial',
      affectedUrl: '',
      orderId: '',
      description: 'Solicito el reporte comparativo mensual de facturación entre cloe.com.mx y Cloe Factory Store para la junta de consejo del viernes.',
      attachments: [],
      slaHours: 48,
  ...
  seed.messages = [
    {
      id: 'msg-seed-1',
      ticketId: 'CLOE-1001',
      senderEmail: 'mariana.lopez@oemoda.com',
      senderName: 'Mariana López',
      senderRole: 'user',
      isInternalNote: false,
      content: 'Ticket creado desde el portal Cloe. Adjunto capturas donde el cliente no ve el descuento reflejado en checkout.',
      source: 'web',
      createdAt: subHours(3)
    },
    {
      id: 'msg-seed-2',
      ticketId: 'CLOE-1001',
      senderEmail: 'dev@oemoda.com',
      senderName: 'Dev Lead (Admin)',
      senderRole: 'admin',
      isInternalNote: true,
      content: 'Nota interna: Revisé el Rates & Benefits de VTEX en la cuenta cloefactorystore. La regla de cluster de clientes tenía un filtro activo de UTM que no estaba recibiendo el checkout. Ajustando la condición de la promoción.',
      source: 'web',
    ...
    },
    {
      ...
      senderRole: 'admin',
      isInternalNote: false,
      content: 'Hola Mariana, ya identificamos el detalle en la configuración de la promoción en VTEX. Estamos aplicando la corrección en staging y en 20 minutos queda en vivo.',
      source: 'email',
    ...
    },
    {
      ...
      senderRole: 'user',
      isInternalNote: false,
      content: 'Excelente, muchas gracias por la pronta respuesta! Quedo al pendiente.',
      source: 'email',
      createdAt: subHours(0.5)
    }
  ];
  ...
  seed.emails = [
    {
      ...
      ticketId: 'CLOE-1001',
      type: 'outbound',
      to: 'mariana.lopez@oemoda.com',
      from: 'soporte.ecommerce@oemoda.com',
      subject: '[CLOE-1001] Actualización de Ticket: Fallo al aplicar descuento en Checkout',
      bodyText: 'Hola Mariana, ya identificamos el detalle en la configuración de la promoción en VTEX...',
      status: 'sent',
      createdAt: subHours(1)
    },
    {
      ...
      from: 'mariana.lopez@oemoda.com',
      subject: 'Re: [CLOE-1001] Actualización de Ticket: Fallo al aplicar descuento en Checkout',
      bodyText: 'Excelente, muchas gracias por la pronta respuesta! Quedo al pendiente.',
      status: 'processed',
      createdAt: subHours(0.5)
    }
  ];

  seed.counters.ticketNumber = 1004;
  return seed;
}
